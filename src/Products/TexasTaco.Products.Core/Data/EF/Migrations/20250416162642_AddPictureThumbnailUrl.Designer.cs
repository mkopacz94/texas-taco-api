...
namespace TexasTaco.Products.Core.Data.EF.Migrations
{
    ...
    [Migration("20250416162642_AddPictureThumbnailUrl")]
    partial class AddPictureThumbnailUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TexasTaco.Products.Core.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("TexasTaco.Shared.Outbox.OutboxMessage<TexasTaco.Shared.EventBus.Products.ProductPriceChangedEventMessage>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("ProductPriceChangedOutboxMessages");
                });
            ...
            modelBuilder.Entity("TexasTaco.Products.Core.Entities.Prize", b =>
                {
                    b.HasOne("TexasTaco.Products.Core.Entities.Picture", "Picture")
                        .WithOne("Prize")
                        .HasForeignKey("TexasTaco.Products.Core.Entities.Prize", "PictureId")
            ...
            modelBuilder.Entity("TexasTaco.Products.Core.Entities.Product", b =>
                {
                    b.HasOne("TexasTaco.Products.Core.Entities.Category", "Category")
                        .WithMany("Products")
