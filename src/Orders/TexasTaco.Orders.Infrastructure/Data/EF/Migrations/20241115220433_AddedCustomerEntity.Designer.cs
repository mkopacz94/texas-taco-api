...
namespace TexasTaco.Orders.Infrastructure.Data.EF.Migrations
{
    ...
    [Migration("20241115220433_AddedCustomerEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TexasTaco.Orders.Domain.Customer.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TexasTaco.Orders.Domain.Customer.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TexasTaco.Orders.Domain.Customer.Address", b =>
                {
                    b.HasOne("TexasTaco.Orders.Domain.Customer.Customer", "Customer")
                        .WithOne("Address")
                        .HasForeignKey("TexasTaco.Orders.Domain.Customer.Address", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
